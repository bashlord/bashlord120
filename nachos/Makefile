...
zip-proj0:
	cd ..; zip -r -q nachos-submission-proj0.zip nachos/; mv nachos-submission-proj0.zip nachos/;

zip-proj1:
	cd ..; zip -r -q nachos-submission-proj1.zip nachos/; mv nachos-submission-proj1.zip nachos/;

zip-proj2:
	cd ..; zip -r -q nachos-submission-proj2.zip nachos/; mv nachos-submission-proj2.zip nachos/;

zip-proj3:
	cd ..; zip -r -q nachos-submission-proj3.zip nachos/; mv nachos-submission-proj3.zip nachos/;
